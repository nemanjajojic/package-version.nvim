...
M.run_async = function(package_config)
	...
	local on_exit = function(job_id, code, event)
		...
		if code ~= 0 then
			window.display_error(stderr_lines, "yarn remove " .. package_name)
	...
	local remove_command = common.prepare_yarn_command("yarn remove " .. package_name .. " --silent", docker_config)
